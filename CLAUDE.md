...
- `claude_manager.py` — Terminal dashboard that monitors `wip/` tasks. Detects blocked, stale, crashed, and completed agents. Runs in its own tmux window via `:AIManager`.
